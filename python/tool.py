# These sample datasets can be deleted once the real parser is inputted.
# Note that this is the format which the frontend expects data; behavior is undefined with a different format.
...
def sub_AP_method_test (file1: str, file2: str):
    ...
    # constitute a sub-AP.
    #
    # The return must be a list, with the "is_defined" map first and the "is_duplicated" map second.
    return [
        sample_is_defined,
        sample_duplicated
    ]